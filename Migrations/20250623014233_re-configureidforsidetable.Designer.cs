...
namespace portal_techgel_api.Migrations
{
    ...
    [Migration("20250623014233_re-configureidforsidetable")]
    partial class reconfigureidforsidetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrganizationEntityRoleInfo", b =>
                {
                    b.Property<int>("ManagedOrganizationEntitiesId")
                        .HasColumnType("integer");

                    b.Property<int>("RoleInfoId")
                        .HasColumnType("integer");

                    b.HasKey("ManagedOrganizationEntitiesId", "RoleInfoId");

                    b.HasIndex("RoleInfoId");

                    b.ToTable("RoleInfoManagedOrganizationEntities", (string)null);
                });

            modelBuilder.Entity("RoleInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<int>>("ManagedOrganizationEntityIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("OrganizationEntityRoleInfo", b =>
                {
                    b.HasOne("portal.Models.OrganizationEntity", null)
                        .WithMany()
                        .HasForeignKey("ManagedOrganizationEntitiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoleInfo", b =>
                {
                    ...
                    b.HasOne("portal.Models.Employee", "Employee")
                        .WithOne("RoleInfo")
                        .HasForeignKey("RoleInfo", "EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
