...
namespace portal_techgel_api.Migrations
{
    ...
    [Migration("20250605043043_EmployeeBirthplace")]
    partial class EmployeeBirthplace
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("portal.Models.LeaveRequestNode", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("ApprovedByIds")
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<List<DateTime>>("ApprovedDates")
                    ...
                    b.PrimitiveCollection<List<int>>("HasBeenApprovedByIds")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("portal.Models.LeaveRequestWorkflow", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("DraftedByIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.PrimitiveCollection<List<int>>("ReceiverIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.OwnsOne("portal.Models.GeneralDocumentInfo", "GeneralDocumentInfo", b1 =>
                        {
                            ...
                            b1.PrimitiveCollection<List<int>>("GeneralWorkflowIds")
                                .IsRequired()
                                .HasColumnType("integer[]");
