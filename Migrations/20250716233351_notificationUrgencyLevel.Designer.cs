...
namespace portal_techgel_api.Migrations
{
    ...
    [Migration("20250716233351_notificationUrgencyLevel")]
    partial class notificationUrgencyLevel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("portal.Models.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("portal.Models.NotificationCategory", b =>
                {
                    ...
                    b.Property<string>("DefaultUrgencyLevel")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("portal.Models.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("portal.Models.StockLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StockId", "WarehouseLocationId")
                        .IsUnique();
            ...
            modelBuilder.Entity("portal.Models.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("portal.Models.WarehouseLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("WarehouseId", "Zone", "Aisle", "Rack", "Shelf")
                        .IsUnique();
            ...
            modelBuilder.Entity("portal.Models.Stock", b =>
                {
                    b.HasOne("portal.Models.Material", "Material")
                        .WithMany()
                        .HasForeignKey("MaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("portal.Models.Warehouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("portal.Models.StockLocation", b =>
                {
                    b.HasOne("portal.Models.Stock", "Stock")
                        .WithMany("StockLocations")
                        .HasForeignKey("StockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("portal.Models.WarehouseLocation", "WarehouseLocation")
                        .WithMany("StockLocations")
