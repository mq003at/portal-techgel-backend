...
namespace portal_techgel_api.Migrations
{
    ...
    [Migration("20250602082559_GeneralWorkflowWithNodes")]
    partial class GeneralWorkflowWithNodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApprovalWorkflowNodeDocument", b =>
                {
                    b.Property<int>("ApprovalWorkflowNodeId")
                        .HasColumnType("integer");

                    b.Property<int>("DocumentsId")
                        .HasColumnType("integer");

                    b.HasKey("ApprovalWorkflowNodeId", "DocumentsId");

                    b.HasIndex("DocumentsId");

                    b.ToTable("ApprovalWorkflowNodeDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("portal.Models.ApprovalWorkflowNode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ApprovalCommentIds")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<int>("GeneralWorkflowId")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ReceiverMessages")
                        .HasColumnType("text");

                    b.Property<string>("ReceiverNames")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("GeneralWorkflowId");

                    b.ToTable("ApprovalWorkflowNodes", (string)null);
                });
            ...
            modelBuilder.Entity("portal.Models.GeneralWorkflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ApprovalWorkflowNodesIds")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("GeneralWorkflows", (string)null);
                });
            ...
            modelBuilder.Entity("ApprovalWorkflowNodeDocument", b =>
                {
                    b.HasOne("portal.Models.ApprovalWorkflowNode", null)
                        .WithMany()
                        .HasForeignKey("ApprovalWorkflowNodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("portal.Models.Document", null)
                        .WithMany()
            ...
            modelBuilder.Entity("portal.Models.ApprovalWorkflowNode", b =>
                {
                    b.HasOne("portal.Models.GeneralWorkflow", "GeneralWorkflow")
                        .WithMany("ApprovalWorkflowNodes")
                        .HasForeignKey("GeneralWorkflowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GeneralWorkflow");
                });
            ...
            modelBuilder.Entity("portal.Models.GeneralWorkflow", b =>
                {
                    b.OwnsOne("portal.Models.GeneralWorkflowInfo", "GeneralWorkflowInfo", b1 =>
                        {
                            b1.Property<int>("GeneralWorkflowId")
                                .HasColumnType("integer");

                            b1.PrimitiveCollection<int[]>("ApprovedByIds")
                                .IsRequired()
                                .HasColumnType("integer[]");
                            ...
                            b1.PrimitiveCollection<int[]>("DraftedByIds")
                                .IsRequired()
                                .HasColumnType("integer[]");
                            ...
                            b1.Property<int>("WorkflowLogic")
                                .HasColumnType("integer");

                            b1.HasKey("GeneralWorkflowId");

                            b1.ToTable("GeneralWorkflows");

                            b1.WithOwner()
                                .HasForeignKey("GeneralWorkflowId");
                        });

                    b.Navigation("GeneralWorkflowInfo")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("portal.Models.GeneralWorkflow", b =>
                {
                    b.Navigation("ApprovalWorkflowNodes");
                });
