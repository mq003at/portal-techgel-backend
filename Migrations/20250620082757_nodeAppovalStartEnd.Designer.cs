...
namespace portal_techgel_api.Migrations
{
    ...
    [Migration("20250620082757_nodeAppovalStartEnd")]
    partial class nodeAppovalStartEnd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleInfo", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("SubordinateIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.OwnsOne("portal.Models.CompanyInfo", "CompanyInfo", b1 =>
                        {
                            ...
                            b1.Property<double>("CompensatoryLeaveTotalDays")
                                .HasColumnType("double precision");
            ...
            modelBuilder.Entity("portal.Models.OrganizationEntity", b =>
                {
                    ...
                    b.HasOne("RoleInfo", null)
                        .WithMany("ManagedOrganizationEntities")
                        .HasForeignKey("RoleInfoId");
            ...
            modelBuilder.Entity("RoleInfo", b =>
                {
                    b.Navigation("ManagedOrganizationEntities");
