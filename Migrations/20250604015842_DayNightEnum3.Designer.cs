...
namespace portal_techgel_api.Migrations
{
    ...
    [Migration("20250604015842_DayNightEnum3")]
    partial class DayNightEnum3
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("RoleInfo", "RoleInfo", b1 =>
                        {
                            ...
                            b1.PrimitiveCollection<int[]>("ManagedOrganizationEntityIds")
                                .IsRequired()
                                .HasColumnType("integer[]")
                                .HasColumnName("ManagedOrganizationEntityIds");

                            b1.PrimitiveCollection<int[]>("SubordinateIds")
                                .IsRequired()
                                .HasColumnType("integer[]")
