...
public abstract class BaseModelWithOnlyIdController<TModel, TReadDTO, TCreateDTO, TUpdateDTO>
    : ApiControllerBase
...
{
    protected readonly IBaseModelWithOnlyIdService<
        TModel,
        TReadDTO,
        TCreateDTO,
        TUpdateDTO
    ...
    protected BaseModelWithOnlyIdController(
        IBaseModelWithOnlyIdService<TModel, TReadDTO, TCreateDTO, TUpdateDTO> service
    )
    {
        _service = service;
    }
