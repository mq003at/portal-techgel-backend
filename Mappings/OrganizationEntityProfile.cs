...
public class OrganizationEntityProfile : BaseModelProfile<
    OrganizationEntity,
    ...
    UpdateOrganizationEntityDTO>
{
    public OrganizationEntityProfile()
    {
        ...
        CreateMap<OrganizationEntity, OrganizationEntityDTO>()
            ...
            .ForMember(dest => dest.EmployeeMainIds,
                opt => opt.MapFrom(src => src.Employees.Select(e => e.MainId ?? string.Empty).ToList()))
            .ForMember(dest => dest.EmployeeFullNames,
            ...
            .ForMember(dest => dest.ManagerName,
                opt => opt.MapFrom(src => src.Manager != null ? FormatEmployeeName(src.Manager) : string.Empty))
            .ForMember(dest => dest.DeputyManagerId,
                opt => opt.MapFrom(src => src.DeputyManagerId))
            .ForMember(dest => dest.DeputyManagerName,
                opt => opt.MapFrom(src => src.DeputyManager != null ? FormatEmployeeName(src.DeputyManager) : null));
