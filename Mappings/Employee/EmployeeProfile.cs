...
public class EmployeeProfile : Profile
{
    public EmployeeProfile()
    {
        ...
        CreateMap<Employee, EmployeeDTO>()
            ...
            .ForMember(
                dest => dest.DeputySupervisorName,
                opt =>
                    opt.MapFrom(src =>
            ...
            .ForMember(
                dest => dest.SubordinateIds,
                opt => opt.MapFrom(src => src.Subordinates.Select(e => e.Id))
            )
            .ForMember(
                dest => dest.SubordinateNames,
                opt =>
                    opt.MapFrom(src =>
            ...
            .ForMember(
                dest => dest.DeputySubordinateIds,
                opt => opt.MapFrom(src => src.DeputySubordinates.Select(e => e.Id))
            )
            .ForMember(
                dest => dest.DeputySubordinateNames,
                opt =>
                    opt.MapFrom(src =>
                        src.DeputySubordinates.Select(e =>
                            $"{e.LastName} {e.MiddleName} {e.FirstName}"
                        )
                    )
            )
            .ForMember(
                dest => dest.OrganizationEntities,
                opt =>
                    opt.MapFrom(src =>
                        src.OrganizationEntityEmployees.Where(oe => oe.OrganizationEntity != null)
                            .Select(oe => oe.OrganizationEntity)
                    )
            )
            .ReverseMap()
            .ReverseMap();
        ...
        CreateMap<CreateEmployeeDTO, Employee>()
            ...
            .ForMember(
                dest => dest.DeputySupervisorId,
                opt => opt.MapFrom(src => src.DeputySupervisorId)
            )
            .ForMember(dest => dest.Subordinates, opt => opt.Ignore())
            .ForMember(dest => dest.DeputySubordinates, opt => opt.Ignore())
            .ForMember(dest => dest.OrganizationEntities, opt => opt.Ignore());
        ...
        CreateMap<UpdateEmployeeDetailsDTO, Employee>()
            ...
            .ForMember(
                dest => dest.DeputySupervisorId,
                opt => opt.MapFrom(src => src.DeputySubordinateIds != null ? (int?)null : null)
            ) // handled manually
